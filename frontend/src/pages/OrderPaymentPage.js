// Frontend user interface functionality and design for the order payment page
...
export default function OrderPaymentPage() {
  ...
  function onApprove(data, actions) {
    return actions.order.capture().then(async function (details) {
      try {
        ...
        navigate(`/reciept/${data.order._id}`);
      } catch (err) {
  ...
  }, [successPay, paypalDispatch, userInfo, navigate, orderId, order]);
          ...
          <Card className="mb-3" border="dark">
            <Card.Body>
              ...
              {!order.isPaid ? (
                ...
                <MessageBox variant="warning">Pending Delivery</MessageBox>
              )}
            </Card.Body>
          </Card>
          <Card className="mb-3" border="dark">
